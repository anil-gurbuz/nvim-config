			...
			vim.api.nvim_create_autocmd("LspAttach", {
				...
				callback = function(event)
					...
					vim.keymap.set(
						...
						"<C-d>",
						vim.lsp.buf.hover,
						{ buffer = event.buf, desc = "LSP: " .. "[C]ode [D]ocumentation" }
					)
					...
					-- code, if the language server you are using supports hem
					--
				...
				handlers = {
					function(server_name)
						...
						if server_name == "basedpyright" then
							...
							server.PyrightSetPythonPath =
								path.join("home", "anil", "anaconda3", "envs", "general", "bin", "python")
						end
